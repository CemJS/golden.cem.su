...
export default function () {
  return (
    <section class="home-exchange">
      <div class="wrapper">
        <div class="home-exchange-content py-5">
          ...
          <div class="home-exchange-content_item home-exchange-content_item-r">
            ...
            <div class="home-exchange-info">
              <p class="text-align-justify">1 GIM = 1 грамму золота.</p>
              <p class="text-align-justify fz-1">Покупать GIM токен можно частями от 0.2 грамма, при этом цена купленного золота фиксируется на момент внесения денег за покупку GIM токена.</p>
            </div>
